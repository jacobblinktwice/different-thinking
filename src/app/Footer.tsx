/* Footer: content on the 5-column grid — everything aligns to the 4th
   ...
   `showAddress` drops the "Say Hello" line and the address on /contact, where
   the page already leads with both and the composer beside them. */

export default function Footer({ showAddress = true }: { showAddress?: boolean }) {
  return (
